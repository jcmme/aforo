...
| 7 | Rediseño "Platino" + espacio de promociones | **Hecho** — identidad visual monocroma tipo guía Michelin: negro profundo, acento crema/platino (adiós dorado), divisores hairline, tipografía elegante (serif Cormorant en títulos, sans Jost en la interfaz, aplicada de forma uniforme). Espacio de promociones del cliente (escaparate neutral, no pertenece a nadie): destacada en grande + lista editorial, cada una lleva a su antro; base lista para las globales de miembros. |
