-- AFORO · Setup completo del esquema (migraciones 0001 a 0011 en orden).
-- Generado para aplicar TODO el esquema + RLS + endurecimiento de una vez.
-- Pégalo completo en el SQL Editor de Supabase y ejecútalo. Después corre
-- seed.sql (datos demo) si quieres navegar con contenido de ejemplo.
-- ---------------------------------------------------------------------------
